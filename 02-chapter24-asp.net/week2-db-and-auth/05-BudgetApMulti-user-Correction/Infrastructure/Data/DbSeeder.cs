...
public class DbSeeder(ApplicationDbContext db, UserManager<User> userManager)
{
  ...
  public async Task SeedAsync(CancellationToken ct = default)
  {
    ...
    if (!await _db.Transactions.AnyAsync(ct))
    {
      ...
      var income3 = new Transaction { Id = Guid.NewGuid(), UserId = user2.Id, Type = TransactionType.Income, Description = "October Salary", Amount = 2500m, Date = DateOnly.Parse("12/1/2025") };
